...
A hypothesis test evaluates evidence against a null hypothesis.
...
- p-value: probability of observing the data assuming H₀ is true
...
In this course, **machine learning** is introduced as an extension of
**statistical modeling**, with a different primary goal.
